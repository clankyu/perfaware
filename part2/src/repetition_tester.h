...
#ifdef __linux__
  AllocType_mmap,
// AllocType_mmap_large_pages, note: couldn't get large pages working in wsl,
// not sure if it has anything to do with windows permissions, maybe at a later
// point
#endif
...
void new_test_wave(Repetition_Tester *tester, Test_Parameters *parameters,
                   f64 seconds_to_try);
...
void print_values(char const *label, u64 cpu_freq,
                  Repetition_Test_Values values);
void print_results(Repetition_Test_Results results, u64 cpu_freq,
